...
namespace TelepathyCommon.Registry
{
    public interface IRegistry
    {
        ...
        /// <returns></returns>
        Task<T> GetValueAsync<T>(string key, string name, CancellationToken token, T defaultValue = default(T));
        ...
        /// <returns>The dictionary of property name and value pairs. For non-exist property, null string will be returned as the value. If the input property names is null or empty, all properties will be returned.</returns>
