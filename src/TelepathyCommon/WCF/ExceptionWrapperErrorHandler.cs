namespace TelepathyCommon.Service
{
    ...
    public class ExceptionWrapperErrorHandler : IErrorHandler
    {
        ...
        /// <returns>
        ///     true if Windows Communication Foundation (WCF) should not abort the session (if there is one) and instance
        ///     context if the instance context is not Single; otherwise, false. The default is false.
        /// </returns>
        ...
        /// <param name="fault">
        ///     The <see cref="System.ServiceModel.Channels.Message" /> object that is returned to the client, or
