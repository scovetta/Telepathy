...
namespace Microsoft.Hpc.Scheduler.Properties
{
    ...
    {
        /// <summary>
        ///   <para>Defines the category of errors into which the <see cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode" /> codes are grouped.</para>
        /// </summary>
        /// <remarks>
        ...
        {
            /// <summary>
            ///   <para>An error occurred while performing an operation (for example, the user tried to delete a 
            /// job template but they do not have permissions to delete templates). This enumeration member represents a value of 0.</para>
            /// </summary>
            OperationError,
            /// <summary>
            ///   <para>The error occurred while validating the job or task before it ran. This enumeration member represents a value of 1.</para>
            /// </summary>
            ValidationError,
            /// <summary>
            ///   <para>The error occurred while assigning resources to the job or task. This enumeration member represents a value of 2.</para>
            /// </summary>
        ...
        const int ErrorCodeStart = unchecked((int)0x80040200);

        const int OperationErrorStart = ErrorCodeStart;
        ...
        /// <summary>
        ///   <para>Invalid template: The template item {0}'s minimum value, {1}, is larger than the minimum 
        /// value of the related template item, {2} (minimum value: {3}).  Correct this inconsistency and try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Invalid template: The template item {0}'s maximum value, {1}, is larger than the maximum 
        /// value of the related template item, {2} (maximum value: {3}).  Correct this inconsistency and try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Invalid template: The template item {0}'s default value, {1}, is larger than the default 
        /// value of the related template item, {2} (default value: {3}).  Correct this inconsistency and try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The default values specified for the job template item {0} must include all of the required values for 
        /// that item.  Ensure that the default values include all the values in the Required Values list, and then try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The software license format is not valid. The valid format is application: numberoflicenses{,application:numberoflicenses.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>You can submit the task only if the task is in the <see cref="Microsoft.Hpc.Scheduler.Properties.TaskState.Configuring" /> state.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The HPC cluster to which you are connected does not support a task of the specified type. Use another 
        /// task type, or connect to an HPC cluster that runs a later version of Windows HPC Server and create your job on that cluster.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        // job progress
        /// <summary>
        ///   <para>The value specified for the progress of the job was not an integer from 0 
        /// to 100. Specify a value for the progress of the job that is an integer from 0 to 100.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The state of the task could not be changed to Configuring because the 
        ...
        /// Wait for the state of the task to change to Queued, Failed, or Canceled, then try again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The task cannot be reconfigured or requeued after it was submitted because the task has the specified task type.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The job cannot be deleted because it was already submitted to the HPC Job 
        /// Scheduler Service. Cancel the job if it has not run and you no longer want it to run.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The task could not be deleted because it was submitted already or because the task is 
        /// a subtask for a parametric task. Cancel the task or subtask if you do not want it to run.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>A task of the specified type was added to the job that is in a state other than Configuring, but tasks of that type can only be 
        /// added while the job is in the Configuring state. Cancel the job and then modify 
        /// it to place the job in the Configuring state, then try to add the task again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>An attempt to add a new task to a job that contains a service task and is not in the Configuring state was made, but a new 
        /// task can only be added to a job with a service task if the job 
        /// is in the Configuring state. Change the state of the job to Configuring and try again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The specified property cannot be set for the specified type of task. Check 
        /// the property that you want to set or change the type of the task and try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The specified property is not supported on the server, which is running 
        ...
        /// the error message. Leave the property unset, or upgrade your HPC cluster to the second version.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The job contains more than 100 parametric sweep tasks. Split the 
        /// job into two or more jobs that each contain 100 or fewer parameter sweep tasks.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        ///   <para>The 
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerTask.Type" /> property for the task cannot be set to the first value specified in the error message when the  
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerTask.IsParametric" /> property is set to the second value in the error message. Set 
        ...
        /// <see cref="Microsoft.Hpc.Scheduler.Properties.TaskType.ParametricSweep" /> and set 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerTask.IsParametric" /> to False, then try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The specified node could not be added to the HPC cluster because a node with that name already exists. Choose a name 
        /// for the node that does not match the name of a node that the HPC cluster already contains, and try to add the node again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The client request could not be handled because the server on which the HPC Job Scheduler Service runs 
        /// is busy. Try again later, or, for more information, check the event log for the HPC Job Scheduler Service on head node.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The client called a function that is not supported on the 
        ...
        /// the client so that it is using the same version of Windows HPC Server as the server.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The client called a function that is not implemented on the 
        /// server, which is running the version of Windows HPC Server that the error message specifies. The  
        /// error message also specifies the version of Windows HPC Server that the client is using. Upgrade 
        /// the server so that it is using the same version of Windows HPC Server as the client.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>A function was called that cannot be applied to the selected job because the job is 
        /// running on the first version of Windows HPC Server that the error message specifies, and the function can only be  
        /// applied to jobs running on the second version of Windows HPC Server that the error message specifies. To apply the 
        /// function to the job, run the job on an HPC cluster that has the second version of Windows HPC Server installed.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The command to modify the email notification task in 
        /// Windows Task Scheduler timed out. Try updating the email notification properties again later.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The email notification properties could not be changed because the command to change the email notification task inside Windows Task 
        /// Scheduler failed with the specified error code and message. For information about the error and how to resolve it, see that error message.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The application was unable to communicate with Windows Task Scheduler because of the 
        /// specified error. For information about the error and how to resolve it, see the specified error message.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The account that was specified for sending email notifications does not have administrator rights on the head node of the HPC 
        /// cluster. Add the specified account to the Administrators group of the head 
        /// node of the HPC cluster, or specify another account that has administrator rights.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The specified node could not be added to the list of nodes on 
        ...
        /// tasks in the job or from the list of nodes on which the job should not run.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The specified nodes could not be added to the list of nodes on which the job should 
        ...
        /// of nodes on which the job should not run, or reduce the minimum resource requirements for the job, then try again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The specified node could not be added to the list of nodes on which the job should not run because the node 
        /// is not present in the HPC cluster. Check the name of the node and that the node is part of the HPC cluster, then try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The list of nodes on which the job should not run cannot be changed as long as the job is 
        /// in the specified state. Wait until the job is in the 
        /// Configuring, Queued, Running, Canceling, Finishing, Canceled, or Failed state, then try again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The operation could not finish because the HPC Job Scheduler Service 
        /// is already using an object that the operation tried to use. Try again later.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The value for the specified property of the job does not match one of the values that the job 
        /// template allows for the property. Change the value of the property to match one of the values that the job template allows.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The value for the specified property of the job is less than the minimum value that the job template allows for the property. For the 
        /// minimum value that the job template allows for the property, see the error 
        /// message, then change the value of the property to no less than that minimum value.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The value for the specified property of the job is larger than the maximum value that the job template allows for the property. For the 
        /// maximum value that the job template allows for the property, see the error 
        /// message, then change the value of the property to no larger than that maximum value.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The value for the specified property of the job does not contain the specified value {1}, which the 
        /// job template for the job required. Update the value of the property to include the value that the job template requires.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The priority cannot be set to the specified value on the version of Windows HPC Server that you are 
        /// using. For closest available priority values, see the error message and change the priority to match one of those values.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.ExpandedPriority" /> properties were set at the same time to incompatible values. Set only the 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.Priority" /> value if you want to run your job on Windows HPC Server 2008, and set only the 
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.ExpandedPriority" /> value if you want to run your job on Windows HPC Server 2008 R2 and is not supported in previous versions.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The job cannot be put on hold in the specified state. Wait 
        /// until the job is in the Queued state, and then try to set the HoldUntil property.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The HoldUntil property for a job cannot be set to a date and time that is in the past. Specify a date and time 
        /// for the HoldUntil property that is in the future, or leave the HoldUntil 
        /// property unset if you no longer want to put running the job on hold.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>A method that only the HPC Job Scheduler Service can call was called. Remove the method call from your application.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The application could not connect to the HPC Job Scheduler Service because the 
        ...
        /// the HPC Job Scheduler Service and that the HPC Job Scheduler Service is started, then try again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The HPC Job Scheduler Service was unable to obtain a security identifier (SID) for the HPCUsers or HPCAdminMirror security group.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The HoldUntil property for a job cannot be set for more than one year in the future. Set the value of the HoldUntil property to 
        /// a date and time that is no more than one year in the future, and reset it later if you must hold the job for more than one year.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The nodes were not added to the list of nodes on which the 
        ...
        /// the job should not run, remove any nodes that the list should not include, and try again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The cancellation message is longer than 128 characters, which is the maximum 
        /// length allowed. Change the cancellation message so that it contains no more than 128 characters.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The application could not connect with the HPC Job Scheduler Service in the specified number of seconds. Try again later.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The attempt to end a service task was unsuccessful because the attempt can only be made 
        /// for a master service task, and not the subtasks of that task. Try ending the master service task instead.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>An attempt to end a service task in the specified state was made. Attempts to end service tasks can only be made 
        /// if the tasks are in the Queued or Running state. Wait until the service task is in the Queued or Running state, and try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The job could not be submitted or modified because the HPC Job Scheduler Service 
        /// is performing maintenance on the database to create capacity for new jobs. Try again in several minutes.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The scheduler database has reached the maximum number of instances of scheduler objects. Please contact your cluster administrator.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>A deployment of Windows Azure with the specified identifier was not found. Check the identifier of the deployment and try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The specified softcard certificate does not match the softcard certificate template specified by the cluster administrator.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The user attempted to specify a certificate template when the cluster already has a specified certificate as the server template.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>This certificate cannot be used for user log on. A certificate with 
        /// a different template for client authentication needs to be used or contact your cluster administrator.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The user of the job doesn’t match the job’s owner. When softcards are required, the user of a job has to be the same as the owner.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The softcard related operation failed. Verify that the HPC key service provider (KSP) been installed on the headnode.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The specified pool cannot be deleted since it is still being used in the specified 
        /// template. You can force delete the pool and the templates will be reset to use the Default Pool.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The value for Valid Exit Codes, does not follow the correct format. The 
        /// value is a string containing integers or integer ranges separated by commas. For example "-1..10,min..-100,0,100..max". "min"  
        /// and "max" can be used to represent minimum and maximum Int32 integers, but "min" or 
        /// "max" alone is not supported. ".." is not a valid range, it must be "min..max" or "max..min".</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The ParentJobIds value is invalid. The value for ParentJobIds should be a set 
        /// of one or more positive integers with a minimum value of one and separated by commas.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The value for CustomProperties should consist of name/value pairs separated by a semicolon, following a regular expression.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The server certificate is not trusted. To correct this, the server certificate needs 
        /// either to have a valid chain of trust, or to be placed in the trusted root store.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        const int OperationErrorEnd = OperationErrorStart + 1000;
        #endregion

        #region validation errors
        const int ValidationErrorStart = OperationErrorEnd;
        ...
        /// <summary>
        ///   <para>This job depends on parent jobs which no longer exist. See the error message for the list of missing parent jobs.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>This job depends on parent jobs which have not been submitted. See the error message for the list of missing parent jobs.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The cluster does not contain a node that supports the specified resource requirements for 
        /// the job (for example, memory or core requirements). Please adjust your requirements and submit the job again. </para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>To reserve resources for a job (when the  job does not contain tasks and 
        /// has requested that it run until canceled), you must specify the maximum and minimum resource values for the job.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>To reserve resources for a job (when the  job does not contain tasks and has requested that it run until canceled), 
        /// you must specify the maximum and minimum resource values for the job 
        /// – you cannot request that the scheduler compute the maximum and minimum resource values.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>You must specify the minimum number of resource units that the job requires if the 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.AutoCalculateMin" /> property is false.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>You must specify the maximum number of resource units that the job requires if the 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.AutoCalculateMax" /> property is false.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>You have exceeded the number of times that a task can be queued again. 
        /// The TaskRetryCount cluster parameter specifies the maximum number of times that a task can be queued again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The minimum resource value for the task must be less than its maximum 
        /// The minimum resource value for the task must be less than that of the job value.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The run-time value for the task is larger than the length of time that the job is scheduled to remain running.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The minimum and maximum resource requirements cannot be computed for a job with exclusive 
        /// access to the nodes. You must specify the minimum and maximum resource values and resubmit the job.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The task cannot specify required nodes when the job has requested that the scheduler compute the required resources.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The task failed because the scheduler could not validate its parent 
        /// job.  Correct the validation error on the parent job and resubmit the job.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The task specifies a list of dependent tasks but the task does not specify a 
        /// name value for itself; each dependent task and the task specifying the dependency must include a name value.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The task dependency tree exceeds the maximum depth. Adjust the job dependencies to reduce the depth of the dependency tree.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Job submission failed because the job submission filter application 
        ...
        /// the path of the submission filter is a fully-qualified (not relative) path name.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Job submission failed because the job submission filter application is not valid. Your cluster administrator 
        /// should check that the submission filter is an executable binary file (".exe" file) or Windows command script (".cmd" file).</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The job contains more than one node preparation task, but a job can 
        /// contain only one such task. Remove all except one of the node preparation tasks, and try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The job contains more than one node release task, but a job can 
        /// contain only one such task. Remove all except one of the node release tasks, and try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Job submission failed because the job contains no runnable tasks other than 
        ...
        /// to the job, or set the job to run until it is canceled, then try again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The specified property cannot be set for tasks of the specified type. Remove 
        /// the value set for the property or change the type of the task, then try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The job contains a node release task, but this HPC cluster has support for node release turned off. Remove the node release job 
        /// from the task, or contact a cluster administrator to request that the support 
        /// for node release tasks be turned on for the HPC cluster, then try again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.Runtime" /> property for the node release task runtime exceeds the globally configured maximum that the error message specifies. Change the value of the  
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.Runtime" /> property so that it is lower than the value that the error message specifies, and try again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>An attempt was made to add a task of the specified type to a job in the Configuring state, but tasks of 
        /// that type cannot be added to a job in the Configuring state. Wait until the job is in a state other than Configuration, and try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The parametric task has current_number subtasks, which exceeds the 
        /// maximum_number of subtasks that a parametric task can have. Split the parametric  
        /// task into two or more parametric tasks that have fewer than the maximum_number of subtasks that a parametric task can have, and try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The specified value of the 
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.TargetResourceCount" /> property for the job is larger than the maximum of the expected range for this job. The value must be between the minimum and maximum values that the error message specifies, or have a value of 0 to specify that the resource count should not be adjusted dynamically. Change the value of the  
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.TargetResourceCount" /> property so that it is in the specified range or is 0, and try again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        ///   <para>The specified value of the 
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.TargetResourceCount" /> property for the job is lower than the minimum of the expected range for this job. The value must be between the minimum and maximum values that the error message specifies, or have a value of 0 to specify that the resource count should not be adjusted dynamically. Change the value of the  
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.TargetResourceCount" /> property so that it is in the specified range or is 0, and try again.</para> 
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        ///   <para>The job contains more than one service task or contains a service task that combines tasks other 
        /// than node preparation and node release tasks. A job can contain only one service task, and if the job  
        /// contains a service task, it can only contain additional tasks that are node preparation or node release tasks. Remove 
        /// the extra service tasks of the tasks that are not service, node preparation, or node release tasks, then try again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The values for the node-related properties of the job create criteria that are not valid for selecting 
        /// nodes on which the job can run. Change the values for the node-related properties of the job, and try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        //task required node 
        /// <summary>
        ///   <para>The specified node is a required node for the task, but that node is not allocated to the job that contains the task.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>A submission filter timed out after the specified number of milliseconds elapsed. Use the 
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.IScheduler.SetClusterParameter(System.String,System.String)" /> method to increase the value of the SubmissionFilterTimeout cluster parameter, and try again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>A submission filter created a job property that is not valid because of the specified 
        /// error. For information about the error and how to resolve it, see the error message for the specified error.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>An administrative job with dependencies between tasks was submitted, but an 
        /// administrative job cannot have dependencies between tasks. Remove the dependencies between tasks and try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>All the candidate node lists for a job with the Uniform node group 
        /// operator cannot be empty. The Job Scheduler service determines the candidate node lists using the following  
        /// job properties: NodeGroups, RequestedNodes, MinMemoryPerNode, MaxMemoryPerNode, MinCoresPerNode, MaxCoresPerNode, and ExcludedNodes. Either reduce the number of 
        /// resources that the job requires, or redefine the relevant job properties, and then submit the job again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>This job with the Uniform node group operator requires more resources than the Job Scheduler service returned for 
        /// this job. See the error message for the specific resource that is insufficient to run this job. The Job Scheduler  
        /// service determines the candidate node lists using the following job properties: NodeGroups, RequestedNodes, MinMemoryPerNode, MaxMemoryPerNode, MinCoresPerNode, MaxCoresPerNode, and ExcludedNodes. Either 
        /// reduce the number of resources that the job requires, or redefine the relevant job properties, and then submit the job again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>This job with the Uniform node group operator has a required node that is not 
        ...
        /// determines the candidate node lists using the following job properties: NodeGroups, RequestedNodes, MinMemoryPerNode, MaxMemoryPerNode, MinCoresPerNode, MaxCoresPerNode, and ExcludedNodes.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Admin jobs cannot use the Uniform node group operator. Admin jobs should use the Union or Intersect operators.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>A job with a node group operator did not specify any node groups. A job that uses a node group operator must specify node groups.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>A Single Node job cannot specify multiple required nodes. Correct the number of required nodes and submit the job again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>A Single Node job cannot have a minimum requirement of more 
        /// than 1 node. Correct the minimum number of nodes required and submit the job again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The single node job requires a greater quantity of resources than any candidate node 
        /// is able to provide. See the error message to determine the resource and quantity required and available.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The single node job requires a greater quantity of a specific resources than any node usable 
        /// by the job is able to provide. See the error message to determine the resource and quantity required and available.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>A job with the specified minimum resource requirements cannot have a greater 
        /// number of required nodes. See the specific error message to determine the resource and quantity required.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The job failed because the tasks failed in the previous submission. Please check the failed task for more details on the failure.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        const int ValidationErrorEnd = ValidationErrorStart + 1000;
        #endregion

        #region execution errors
        const int ExecutionErrorStart = ValidationErrorEnd;
        ...
        /// <summary>
        ///   <para>The job exceeded its run-time limit. See 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.Runtime" /> and 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerTask.Runtime" />.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The job was preempted by a higher priority job. For details, see the 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.CanPreempt" /> and the PreemptionType cluster parameter in the Remarks section of 
        ...
        /// <summary>
        ///   <para>The task was canceled while it was running because a job with higher priority preempted the 
        /// task.  If the task can be rerun, the HPC Job Scheduler service will attempt to automatically queue it again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Unable to open the file from which the job redirects standard input on the specified node. Verify 
        /// that the file exists and that the account under which the job runs has access to the file, then try again.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Unable to open or create the file to which the job should 
        ...
        /// the account under which the job runs has permission to create the file, then try again.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Unable to access the working directory for the job on the specified node. Check that the directory specified as the 
        /// working directory for the job exists on the node, and that the account under which the job runs has access to the directory.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The subtask of a service task was canceled because the HPC Job Scheduler Service could not requeue the 
        /// subtask together with the rest of the job. The HPC Job Scheduler Service will create another subtask to replace the canceled subtask.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The task was canceled by the user while it was running. For more information, see the specified cancellation message.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The node preparation task failed on the specified node. For information about 
        /// the error and how to resolve it, see the error for the node preparation task.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The task is running on a node that the job that contains the task can no longer use. The nodes that a task can use 
        /// can change when the nodes that belong to node groups in the HPC 
        /// cluster change, or when nodes are added to the node exclusion list for the job.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        const int ExecutionErrorEnd = ExecutionErrorStart + 1000;
        #endregion

        #region Exception codes
        const int ExceptionCodeStart = ExecutionErrorEnd;
        const int ExceptionCodeEnd = ExceptionCodeStart + 1000;
        #endregion

        #region ServiceHost exit codes
        /// <summary>
        ///   <para />
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        ///   <para>Failed to find the service assembly file. Make sure that the assembly has been deployed and registered on the node. </para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Failed to load the service assembly. Make sure that the security settings 
        /// for the assembly are correct and that 
        /// the service assembly information at HKEY_LOCAL_MACHINE\Microsoft\Hpc\ServiceRegistry\&lt;ServiceName&gt;\AssemblyPath) is correct.</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Failed to find the service contract interface from the service assembly. Make sure 
        /// that the contract information provided in the 
        /// service registration is valid (see HKLM\Microsoft\Hpc\ServiceRegistry\&lt;ServiceName&gt;\AssemblyPath and Contract type).</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Failed to find the service type from the service assembly. Make 
        /// sure that the type information in the 
        /// service registration is valid (see HKEY_LOCAL_MACHINE\Microsoft\Hpc\ServiceRegistry\&lt;ServiceName&gt;\AssemblyPath and ServiceType).</para> 
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Failed to open the service host. Make sure that the NetTcp port sharing service is running 
        /// and that the user has permission to use port sharing service, and that the firewall settings are correct. </para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Cannot locate the service registration file in both %CCP_HOME%ServiceRegistration folder and user 
        /// specified central registration folder (if any). Make sure that the service has been successfully deployed.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>Not able to find the service assembly file name in the 
        /// service registration file. Make sure that the service registration file has the correct format.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The service registration file is not in the correct format. Use the service 
        /// registration XML schema to make sure that the service registration file is in the correct format.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// <summary>
        ///   <para>The command line for the HpcServiceHost.exe command contained an error. See the error message for more information.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        #region ServiceBroker exit codes
        /// <summary>
        ///   <para />
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        ///   <para>The BackendBinding value specified in the service broker's configuration 
        /// file is not valid. Correct the binding and start a new session.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        /// </returns>
        /// <remarks>
        ///   <para>This field provides additional information about the circumstances under which an 
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Operation_AuthenticationFailure" /> error occurred. This field corresponds to a value of 1.</para> 
        /// </remarks>
        /// <seealso cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Operation_AuthenticationFailure" />
        ...
        /// <summary>
        ///   <para>Indicates that credential reuse is enabled and softcard-based authentication is allowed, but no credentials are saved.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        ///   <para>This field provides additional information about the circumstances under which an 
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Operation_AuthenticationFailure" /> error occurred. This field corresponds to a value of 2.</para> 
        /// </remarks>
        /// <seealso cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Operation_AuthenticationFailure" />
        ...
        /// <summary>
        ///   <para>Indicates that credential reuse is enabled and softcard-based 
        /// authentication is allowed, and the saved certificate is about to expire.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        ///   <para>This field provides additional information about the circumstances under which an 
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Operation_AuthenticationFailure" /> error occurred. This field corresponds to a value of 3.</para> 
        /// </remarks>
        /// <seealso cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Operation_AuthenticationFailure" />
        ...
        ///   <para>This field provides additional information about the circumstances under which an 
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Operation_AuthenticationFailure" /> error occurred. This field corresponds to a value of 4.</para> 
        /// </remarks>
        /// <seealso cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Operation_AuthenticationFailure" />
        ...
        /// <summary>
        ///   <para>Indicates that softcard-based authentication is required and credential reuse is enabled, but no credentials are saved.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        ///   <para>This field provides additional information about the circumstances under which an 
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Operation_AuthenticationFailure" /> error occurred. This field corresponds to a value of 5.</para> 
        /// </remarks>
        /// <seealso cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Operation_AuthenticationFailure" />
        ...
        /// <summary>
        ///   <para>Indicates that softcard-based authentication is required, credential 
        /// reuse is enabled, and the saved certificate is about to expire.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        ///   <para>This field provides additional information about the circumstances under which an 
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Operation_AuthenticationFailure" /> error occurred. This field corresponds to a value of 6.</para> 
        /// </remarks>
        /// <seealso cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Operation_AuthenticationFailure" />
        ...
        ///   <para>This field provides additional information about the circumstances under which an 
        /// 
        /// <see cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Operation_AuthenticationFailure" /> error occurred. This field corresponds to a value of 7.</para> 
        /// </remarks>
        /// <seealso cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Operation_AuthenticationFailure" />
        ...
        #region resource assignment errors
        const int ResourceAssignmentErrorStart = CustomErrorEnd;
        ...
        const int ResourceAssignmentErrorEnd = ResourceAssignmentErrorStart + 1000;
        #endregion

        //prefix of resource item name in resources
        const string ResourcePrefix = "SchedulerError_";

        /// <summary>
        ///   <para>Separator used to separate the insertion strings for the error message text. See 
        /// <see cref="Microsoft.Hpc.Scheduler.Properties.SchedulerException.Params" />.</para>
        /// </summary>
        /// <returns>
        ///   <para />
        /// </returns>
        ...
        static Dictionary<int, string> errorMessages = null;
        ...
        /// </param>
        /// <returns>
        ///   <para>The error category. For possible values, see the  <see cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode.Category" /> enumeration.</para>
        /// </returns>
        public static Category ErrorCategory(int code)
        {
            ...
            else if (code < ValidationErrorEnd && code > ValidationErrorStart)
            {
                return Category.ValidationError;
            }
            else if (code < ResourceAssignmentErrorEnd && code > ResourceAssignmentErrorStart)
            {
                return Category.ResourceAssignmentError;
            }
            else if (code < ExecutionErrorEnd && code > ExecutionErrorStart)
            {
            ...
            if (errorMessages == null)
            {
                lock (initLock)
                {
                    if (errorMessages == null)
                    {
                        ...
                        foreach (FieldInfo field in typeof(ErrorCode).GetFields(BindingFlags.Public | BindingFlags.Static))
                        {
        ...
        public static string ToString(int errorCode, string errorParams)
        {
            ...
            if (errorParams != null)  // An empty string is allowed
            {
                arguments = errorParams.Split(new string[] { ArgumentSeparator }, StringSplitOptions.None);
            }
        ...
        /// <summary>
        ///   <para>Retrieves whether you can try the operation that generated the specified error value again without making changes.</para>
        /// </summary>
        /// <param name="errorCode">
        ///   <para>An integer value for the error. This can be any of the fields in the 
        /// <see cref="Microsoft.Hpc.Scheduler.Properties.ErrorCode" /> class.</para>
        /// </param>
        /// <returns>
        ///   <para>A 
        /// 
        /// <see cref="System.Boolean" /> that indicates whether you can try the operation that generated the specified error value again without making changes. True indicates that you can try the operation that generated the specified error value again without making changes. False indicates that you cannot try the operation that generated the specified error value again without making changes.</para> 
        /// </returns>
