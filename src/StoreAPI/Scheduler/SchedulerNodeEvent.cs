...
namespace Microsoft.Hpc.Scheduler
{
    ...
    [ComVisible(true)]
    [Guid(ComGuids.GuidINodeStateChangeEventArgs)]
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid(ComGuids.GuidNodeStateChangeEventArgsClass)]
    ...
    /// <summary>
    ///   <para>Defines the interface that COM applications implement to handle events that an 
    /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerNode" /> object raises.</para>
    /// </summary>
    [ComVisible(true)]
    [Guid(ComGuids.GuidISchedulerNodeEvents)]
    ...
    ///   <para>Defines the parameters that are passed to the 
    /// 
    /// <see cref="Microsoft.Hpc.Scheduler.NodeReachableHandler" /> event handler when the HPC Node Manager Service on a node becomes reachable or unreachable.</para> 
    /// </summary>
    /// <remarks>
    ///   <para>For information about how to implement the event handler, see the 
    /// <see cref="Microsoft.Hpc.Scheduler.NodeReachableHandler" /> delegate. This event handler is called when the 
    /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerNode.OnNodeReachable" /> event occurs.</para>
    /// </remarks>
    ...
    [ComVisible(true)]
    [Guid(ComGuids.GuidINodeReachableChangeEventArgs)]
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid(ComGuids.GuidNodeReachableChangeEventArgsClass)]
    [ClassInterface(ClassInterfaceType.None)]
    ...
    /// <summary>
    ///   <para>Defines the interface that COM applications implement to handle the events that an 
    /// 
    /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerNode" /> object raises when the HPC Node Manager Service on a node become reachable or unreachable.</para> 
    /// </summary>
    [ComVisible(true)]
    [Guid(ComGuids.GuidISchedulerNodeReachableEvents)]
    [InterfaceType(ComInterfaceType.InterfaceIsIDispatch)]
