...
namespace Microsoft.Hpc.Scheduler
{
    ...
    /// </summary>
    /// <remarks>
    ///   <para>To create a task, call the <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.CreateTask" /> method.</para>
    /// </remarks>
    /// <example />
    ...
    [ComVisible(true)]
    [GuidAttribute(ComGuids.GuidITaskV4SP5)]
    public interface ISchedulerTask
    {
        ...
        /// <summary>
        ///   <para>Retrieves the counter data for the task.</para>
        /// </summary>
        /// <returns>
        ...
        /// </returns>
        /// <remarks>
        ///   <para>To set custom properties, call the 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerTask.SetCustomProperty(System.String,System.String)" /> method.</para>
        /// </remarks>
        ...
        /// </value>
        /// <remarks>
        ///   <para>The list specifies the nodes on which the task can run. The list of required nodes must be a subset of the nodes in the 
        /// <see cref="Microsoft.Hpc.Scheduler.ISchedulerJob.RequestedNodes" /> property, if set.</para>
        /// </remarks>
        /// <example />
        ...
        /// </value>
        /// <remarks>
        ///   <para>Typically, you use dependencies to break a large task into smaller 
        /// subtasks. For example, if task A needs to finish before task B, which needs  
        /// to finish before task C, then task B depends on A and task C depends on B. Task B will not run until A finishes, fails, or is canceled.</para>
        ///   <para>The server checks for circular dependencies.</para>
        ///   <para>This string is in Comma Separated Values, or CSV, format. Therefore, task names must not contain commas.</para>
        /// </remarks>
        /// <example />
        ...
        /// <summary>
        ///   <para>Gets or sets a task type that defines how to run the command for the task.</para>
        /// </summary>
        /// <value>
        ///   <para>A 
        /// <see cref="Microsoft.Hpc.Scheduler.Properties.TaskType" /> value that defines how to run the command for the task. The default value is 
        /// <see cref="Microsoft.Hpc.Scheduler.Properties.TaskType.Basic" />.</para>
        /// </value>
        ...
        /// </summary>
        System.String RequestedNodeGroup { get; set; }
