namespace Microsoft.Hpc.Scheduler.Session.Internal.BrokerLauncher
{
    ...
    internal interface ISchedulerHelper : IDisposable
    {
        ...
        Task<bool> IsJobPurged(int jobId);
        ...
        Task UpdateSuspended(int sessionId, bool suspended);
        ...
        Task<BrokerRecoverInfo> TryGetSessionStartInfoFromFininshedJobs(int sessionId);
        ...
        Task<bool> IsDiagTraceEnabled(int jobId);
