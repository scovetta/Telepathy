...
namespace Microsoft.Hpc.ServiceBroker.BackEnd
{
    ...
    internal class WssDispatcherInfo : ServiceTaskDispatcherInfo
    {
        ...
        public WssDispatcherInfo(int jobId, string taskId, int capacity, string machineName, string machineVirtualName, int firstCoreId, string networkPrefix, Microsoft.Hpc.Scheduler.Session.Data.NodeLocation location)
