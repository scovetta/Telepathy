...
namespace Microsoft.Hpc.ServiceBroker.BackEnd
{
    ...
    internal interface IProxyServiceControlClient : IProxyServiceManagement
    {
        ...
        IAsyncResult BeginExit(string machine, int jobId, int taskId, int port, BindingData data, AsyncCallback callback, object state);
    ...
    internal class ProxyServiceControlClient : ClientBase<IProxyServiceControlClient>, IProxyServiceControlClient
    {
        ...
        public IAsyncResult BeginExit(string machine, int jobId, int taskId, int port, BindingData data, AsyncCallback callback, object state)
        {
