...
namespace Microsoft.Telepathy.ServiceBroker.BackEnd.AzureQueue
{
    ...
    /// </summary>
    [Serializable]
    public class AzureQueueItem : ISerializable, IDisposable
    {
        /// <summary>
        ...
        public AzureQueueItem(Message msg)
        {
        ...
        protected AzureQueueItem(SerializationInfo info, StreamingContext context)
        {
        ...
        public static byte[] Serialize(Message message)
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                using (AzureQueueItem item = new AzureQueueItem(message))
                {
        ...
        public static Message Deserialize(byte[] byteArray)
        {
            using (MemoryStream stream = new MemoryStream(byteArray))
            {
                ...
                var item = formatter.Deserialize(stream) as AzureQueueItem;
