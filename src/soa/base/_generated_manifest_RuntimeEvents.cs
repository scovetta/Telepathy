...
namespace Microsoft.Telepathy.RuntimeTrace
{
    ...
    public sealed class RuntimeTraceTemplateFormatterProvider : TemplateFormatterProvider
    {
        
        private static System.Collections.Generic.Dictionary<int, TemplateFormatter> formatterDic = new System.Collections.Generic.Dictionary<int, TemplateFormatter>();
        ...
        protected override System.Collections.Generic.IDictionary<int, TemplateFormatter> TemplateFormatterDic
        {
            get
            {
        ...
        private sealed class BrokerClientIdFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                int offset = 0;
                result.Add("SessionId", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                result.Add("ClientId", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
        
        private sealed class BrokerClientIdWithStateFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("ClientId", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                result.Add("State", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
        
        private sealed class SessionCreatingFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("SessionId", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                result.Add("UserName", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
        
        private sealed class MessageFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("SessionId", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                result.Add("MessageId", TraceEventRawReaders.ReadGuid(pointer, offset));
                offset = (offset + 16);
                return result;
            }
        }
        
        private sealed class MessageWithFaultFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("MessageId", TraceEventRawReaders.ReadGuid(pointer, offset));
                offset = (offset + 16);
                result.Add("Fault", TraceEventRawReaders.ReadBoolean(pointer, offset));
                offset = (offset + 1);
                return result;
            }
        }
        
        private sealed class ServiceConfigCheckFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                System.Collections.Generic.Dictionary<string, object> result = new System.Collections.Generic.Dictionary<string, object>();
                int offset = 0;
                result.Add("FileName", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
        
        private sealed class StringWithMessageIdFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("MessageId", TraceEventRawReaders.ReadGuid(pointer, offset));
                offset = (offset + 16);
                result.Add("DispatchId", TraceEventRawReaders.ReadGuid(pointer, offset));
                offset = (offset + 16);
                result.Add("String", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
        
        private sealed class StringFormatter : TemplateFormatter
        {
        ...
        private sealed class PureStringFormatter : TemplateFormatter
        {
        ...
        private sealed class DispatcherFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("SessionId", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                result.Add("TaskId", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                return result;
            }
        }
        
        private sealed class FrontendRequestMessageFormatter : TemplateFormatter
        {
        ...
        private sealed class FrontendRequestMessageAuthenticationErrorFormatter : TemplateFormatter
        {
        ...
        private sealed class FrontendRequestMessageGeneralErrorFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("MessageId", TraceEventRawReaders.ReadGuid(pointer, offset));
                offset = (offset + 16);
                result.Add("Exception", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
        
        private sealed class BackendRequestMessageFormatter : TemplateFormatter
        {
        ...
        private sealed class BackendRequestMessageWithEPRFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("DispatchId", TraceEventRawReaders.ReadGuid(pointer, offset));
                offset = (offset + 16);
                result.Add("TargetMachine", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                result.Add("EndpointAddress", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
        
        private sealed class BackendGeneratedFaultReplyFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("MessageId", TraceEventRawReaders.ReadGuid(pointer, offset));
                offset = (offset + 16);
                result.Add("FaultReply", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
        
        private sealed class BackendResponseMessageWithExceptionAndRetryCountFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("MessageId", TraceEventRawReaders.ReadGuid(pointer, offset));
                offset = (offset + 16);
                result.Add("RetryCount", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                result.Add("Exception", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
        ...
        private sealed class BackendResponseMessageFormatter : TemplateFormatter
        {
        ...
        private sealed class BackendResponseMessageWithFaultCodeFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("MessageId", TraceEventRawReaders.ReadGuid(pointer, offset));
                offset = (offset + 16);
                result.Add("FaultCode", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
        
        private sealed class BackendResponseMessageRetryFormatter : TemplateFormatter
        {
        ...
        private sealed class BackendMessageWithExceptionFormatter : TemplateFormatter
        {
        ...
        private sealed class SessionFormatter : TemplateFormatter
        {
        ...
        private sealed class SessionHostUriFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("SessionId", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                result.Add("HostUri", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
        
        private sealed class SessionFrontendUriFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("SessionId", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                result.Add("Symbol", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                result.Add("FrontendUri", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
        
        private sealed class SessionControllerUriFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("Symbol", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                result.Add("ControllerUri", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                result.Add("GetResponseUri", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
        
        private sealed class SessionBindingInfoFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("Symbol", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                result.Add("MaxMessageSize", TraceEventRawReaders.ReadInt64(pointer, offset));
                offset = (offset + 8);
                result.Add("ReceiveTimeout", TraceEventRawReaders.ReadInt64(pointer, offset));
                offset = (offset + 8);
                result.Add("SendTimeout", TraceEventRawReaders.ReadInt64(pointer, offset));
                offset = (offset + 8);
                result.Add("MessageVersion", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                result.Add("Scheme", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
        
        private sealed class BrokerWorkerMessageFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                System.Collections.Generic.Dictionary<string, object> result = new System.Collections.Generic.Dictionary<string, object>();
                int offset = 0;
                result.Add("Id", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                result.Add("Message", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
        
        private sealed class BrokerWorkerExitCodeFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                System.Collections.Generic.Dictionary<string, object> result = new System.Collections.Generic.Dictionary<string, object>();
                int offset = 0;
                result.Add("PID", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                result.Add("ExitCode", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                return result;
            }
        }
        
        private sealed class BrokerWorkerPIDFormatter : TemplateFormatter
        {
        ...
        private sealed class AzureStorageQueueFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("SessionId", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                result.Add("QueueName", TraceEventRawReaders.ReadUnicodeString(pointer, offset));
                offset = TraceEventRawReaders.SkipUnicodeString(pointer, offset);
                return result;
            }
        }
    ...
    public sealed class SOADiagTraceTemplateFormatterProvider : TemplateFormatterProvider
    {
        ...
        private sealed class SOADiagStringFormatter : TemplateFormatter
        {
        ...
        private sealed class EventIdFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                System.Collections.Generic.Dictionary<string, object> result = new System.Collections.Generic.Dictionary<string, object>();
                int offset = 0;
                result.Add("EventId", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                return result;
            }
        }
        
        private sealed class ThrottleFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                System.Collections.Generic.Dictionary<string, object> result = new System.Collections.Generic.Dictionary<string, object>();
                int offset = 0;
                result.Add("CurrentBufferSize", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                return result;
            }
        }
        
        private sealed class EventIdPlusBufferFormatter : TemplateFormatter
        {
            ...
            protected override System.Collections.Generic.Dictionary<string, object> ParseBinaryDataInternal(System.IntPtr pointer)
            {
                ...
                result.Add("SessionId", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                result.Add("BufferId", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                result.Add("Count", TraceEventRawReaders.ReadInt32(pointer, offset));
                offset = (offset + 4);
                result.Add("CreatedTime", System.DateTime.FromFileTimeUtc(TraceEventRawReaders.ReadInt64(pointer, offset)));
                offset = (offset + 8);
                return result;
            }
        }
        
        private sealed class BufferFormatter : TemplateFormatter
        {
        ...
        private sealed class BufferPlusExceptionFormatter : TemplateFormatter
        {
    ...
    public sealed class DataSvcTraceTemplateFormatterProvider : TemplateFormatterProvider
    {
    ...
    public sealed class RuntimeTraceWrapper
    {
        ...
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, RuntimeTraceEventIdConst.TextVerboseEventId, LogStringFormatTable.StringMessage, SessionId, String);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogTextVerbose(SessionId, String);
        }
        
        public bool LogTextInfo(string SessionId, string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.TextInfoEventId, LogStringFormatTable.StringMessage, SessionId, String);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogTextInfo(SessionId, String);
        }
        
        public bool LogTextWarning(string SessionId, string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.TextWarningEventId, LogStringFormatTable.StringMessage, SessionId, String);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogTextWarning(SessionId, String);
        }
        
        public bool LogTextError(string SessionId, string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Error, RuntimeTraceEventIdConst.TextErrorEventId, LogStringFormatTable.StringMessage, SessionId, String);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogTextError(SessionId, String);
        }
        
        public bool LogTextCritial(string SessionId, string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Critical, RuntimeTraceEventIdConst.TextCritialEventId, LogStringFormatTable.StringMessage, SessionId, String);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogTextCritial(SessionId, String);
        }
        
        public bool LogEventTextCritial(string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Critical, RuntimeTraceEventIdConst.EventTextCritialEventId, LogStringFormatTable.PureString, String);
            if ((this.IsTraceEnabled("0") == false))
            {
                return false;
            }
            return this.etwTrace.LogEventTextCritial(String);
        }
        
        public bool LogEventTextVerbose(string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, RuntimeTraceEventIdConst.EventTextVerboseEventId, LogStringFormatTable.PureString, String);
            if ((this.IsTraceEnabled("0") == false))
            {
                return false;
            }
            return this.etwTrace.LogEventTextVerbose(String);
        }
        
        public bool LogEventTextInfo(string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.EventTextInfoEventId, LogStringFormatTable.PureString, String);
            if ((this.IsTraceEnabled("0") == false))
            {
                return false;
            }
            return this.etwTrace.LogEventTextInfo(String);
        }
        
        public bool LogEventTextWarning(string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.EventTextWarningEventId, LogStringFormatTable.PureString, String);
            if ((this.IsTraceEnabled("0") == false))
            {
                return false;
            }
            return this.etwTrace.LogEventTextWarning(String);
        }
        
        public bool LogEventTextError(string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Error, RuntimeTraceEventIdConst.EventTextErrorEventId, LogStringFormatTable.PureString, String);
            if ((this.IsTraceEnabled("0") == false))
            {
                return false;
            }
            return this.etwTrace.LogEventTextError(String);
        }
        
        public bool LogHostRequestReceived(string SessionId, System.Guid MessageId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, RuntimeTraceEventIdConst.HostRequestReceivedEventId, LogStringFormatTable.HostRequestReceived, SessionId, MessageId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogHostRequestReceived(SessionId, MessageId);
        }
        
        public bool LogHostResponseSent(string SessionId, System.Guid MessageId, bool Fault)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, RuntimeTraceEventIdConst.HostResponseSentEventId, LogStringFormatTable.HostResponseSent, SessionId, MessageId, Fault);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogHostResponseSent(SessionId, MessageId, Fault);
        }
        
        public bool LogHostStart(string SessionId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.HostStartEventId, LogStringFormatTable.HostStart, SessionId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogHostStart(SessionId);
        }
        
        public bool LogHostStop(string SessionId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.HostStopEventId, LogStringFormatTable.HostStart, SessionId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogHostStop(SessionId);
        }
        
        public bool LogHostServiceConfigCheck(string FileName)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.HostServiceConfigCheckEventId, LogStringFormatTable.HostServiceConfigCheck, FileName);
            if ((this.IsTraceEnabled("0") == false))
            {
                return false;
            }
            return this.etwTrace.LogHostServiceConfigCheck(FileName);
        }
        
        public bool LogHostAssemblyLoaded(string SessionId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.HostAssemblyLoadedEventId, LogStringFormatTable.HostAssemblyLoaded, SessionId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogHostAssemblyLoaded(SessionId);
        }
        
        public bool LogHostCanceled(string SessionId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.HostCanceledEventId, LogStringFormatTable.HostCanceled, SessionId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogHostCanceled(SessionId);
        }
        
        public bool LogFrontEndRequestReceived(string SessionId, string ClientId, System.Guid MessageId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, RuntimeTraceEventIdConst.FrontEndRequestReceivedEventId, LogStringFormatTable.FrontEndRequestReceived, SessionId, ClientId, MessageId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogFrontEndRequestReceived(SessionId, ClientId, MessageId);
        }
        
        public bool LogFrontEndResponseSent(string SessionId, string ClientId, System.Guid MessageId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, RuntimeTraceEventIdConst.FrontEndResponseSentEventId, LogStringFormatTable.FrontEndResponseSent, SessionId, ClientId, MessageId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogFrontEndResponseSent(SessionId, ClientId, MessageId);
        }
        ...
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, RuntimeTraceEventIdConst.BackendRequestSentEventId, LogStringFormatTable.BackendRequestSent, SessionId, TaskId, MessageId, DispatchId, TargetMachine, EndpointAddress);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendRequestSent(SessionId, TaskId, MessageId, DispatchId, TargetMachine, EndpointAddress);
        }
        
        public bool LogBackendResponseReceived(string SessionId, string TaskId, System.Guid MessageId, bool Fault)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, RuntimeTraceEventIdConst.BackendResponseReceivedEventId, LogStringFormatTable.BackendResponseReceived, SessionId, TaskId, MessageId, Fault);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendResponseReceived(SessionId, TaskId, MessageId, Fault);
        }
        
        public bool LogBackendRequestSentFailed(string SessionId, string TaskId, System.Guid MessageId, string Exception)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.BackendRequestSentFailedEventId, LogStringFormatTable.BackendRequestSentFailed, SessionId, TaskId, MessageId, Exception);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendRequestSentFailed(SessionId, TaskId, MessageId, Exception);
        }
        ...
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.BackendResponseReceivedFailedEventId, LogStringFormatTable.BackendResponseReceivedFailed, SessionId, TaskId, MessageId, RetryCount, Exception);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendResponseReceivedFailed(SessionId, TaskId, MessageId, RetryCount, Exception);
        }
        
        public bool LogFrontEndResponseSentFailed(string SessionId, string ClientId, System.Guid MessageId, string Exception)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.FrontEndResponseSentFailedEventId, LogStringFormatTable.FrontEndResponseSentFailed, SessionId, ClientId, MessageId, Exception);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogFrontEndResponseSentFailed(SessionId, ClientId, MessageId, Exception);
        }
        
        public bool LogFrontEndRequestRejectedClientIdNotMatch(string SessionId, string ClientId, System.Guid MessageId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.FrontEndRequestRejectedClientIdNotMatchEventId, LogStringFormatTable.FrontEndRequestRejectedClientIdNotMatch, SessionId, ClientId, MessageId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogFrontEndRequestRejectedClientIdNotMatch(SessionId, ClientId, MessageId);
        }
        
        public bool LogFrontEndRequestRejectedClientIdInvalid(string SessionId, string ClientId, System.Guid MessageId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.FrontEndRequestRejectedClientIdInvalidEventId, LogStringFormatTable.FrontEndRequestRejectedClientIdInvalid, SessionId, ClientId, MessageId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogFrontEndRequestRejectedClientIdInvalid(SessionId, ClientId, MessageId);
        }
        
        public bool LogFrontEndRequestRejectedClientStateInvalid(string SessionId, string ClientId, System.Guid MessageId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.FrontEndRequestRejectedClientStateInvalidEventId, LogStringFormatTable.FrontEndRequestRejectedClientStateInvalid, SessionId, ClientId, MessageId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogFrontEndRequestRejectedClientStateInvalid(SessionId, ClientId, MessageId);
        }
        ...
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.BackendResponseReceivedRetryOperationErrorEventId, LogStringFormatTable.BackendResponseReceivedRetryOperationError, SessionId, TaskId, MessageId, RetryCount);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendResponseReceivedRetryOperationError(SessionId, TaskId, MessageId, RetryCount);
        }
        ...
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.BackendResponseReceivedRetryLimitExceedEventId, LogStringFormatTable.BackendResponseReceivedRetryLimitExceed, SessionId, TaskId, MessageId, RetryCount);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendResponseReceivedRetryLimitExceed(SessionId, TaskId, MessageId, RetryCount);
        }
        
        public bool LogBackendRequestPutBack(string SessionId, string TaskId, System.Guid MessageId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, RuntimeTraceEventIdConst.BackendRequestPutBackEventId, LogStringFormatTable.BackendRequestPutBack, SessionId, TaskId, MessageId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendRequestPutBack(SessionId, TaskId, MessageId);
        }
        
        public bool LogBackendGeneratedFaultReply(string SessionId, string TaskId, System.Guid MessageId, string FaultReply)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, RuntimeTraceEventIdConst.BackendGeneratedFaultReplyEventId, LogStringFormatTable.BackendGeneratedFaultReply, SessionId, TaskId, MessageId, FaultReply);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendGeneratedFaultReply(SessionId, TaskId, MessageId, FaultReply);
        }
        ...
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.FrontEndRequestRejectedAuthenticationErrorEventId, LogStringFormatTable.FrontEndRequestRejectedAuthenticationError, SessionId, ClientId, MessageId, UserName);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogFrontEndRequestRejectedAuthenticationError(SessionId, ClientId, MessageId, UserName);
        }
        ...
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.FrontEndRequestRejectedGeneralErrorEventId, LogStringFormatTable.FrontEndRequestRejectedGeneralError, SessionId, ClientId, MessageId, Exception);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogFrontEndRequestRejectedGeneralError(SessionId, ClientId, MessageId, Exception);
        }
        
        public bool LogBackendHandleResponseFailed(string SessionId, string TaskId, System.Guid MessageId, string Exception)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Error, RuntimeTraceEventIdConst.BackendHandleResponseFailedEventId, LogStringFormatTable.BackendHandleResponseFailed, SessionId, TaskId, MessageId, Exception);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendHandleResponseFailed(SessionId, TaskId, MessageId, Exception);
        }
        ...
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Error, RuntimeTraceEventIdConst.BackendHandleEndpointNotFoundExceptionFailedEventId, LogStringFormatTable.BackendHandleEndpointNotFoundExceptionFailed, SessionId, TaskId, MessageId, Exception);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendHandleEndpointNotFoundExceptionFailed(SessionId, TaskId, MessageId, Exception);
        }
        
        public bool LogBackendHandleExceptionFailed(string SessionId, string TaskId, System.Guid MessageId, string Exception)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Error, RuntimeTraceEventIdConst.BackendHandleExceptionFailedEventId, LogStringFormatTable.BackendHandleExceptionFailed, SessionId, TaskId, MessageId, Exception);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendHandleExceptionFailed(SessionId, TaskId, MessageId, Exception);
        }
        ...
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.BackendEndpointNotFoundExceptionOccuredEventId, LogStringFormatTable.BackendEndpointNotFoundExceptionOccured, SessionId, TaskId, MessageId, Exception);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendEndpointNotFoundExceptionOccured(SessionId, TaskId, MessageId, Exception);
        }
        
        public bool LogBackendDispatcherClosed(string SessionId, string TaskId, System.Guid MessageId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.BackendDispatcherClosedEventId, LogStringFormatTable.BackendDispatcherClosed, SessionId, TaskId, MessageId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendDispatcherClosed(SessionId, TaskId, MessageId);
        }
        
        public bool LogBackendResponseReceivedSessionFault(string SessionId, string TaskId, System.Guid MessageId, string FaultCode)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.BackendResponseReceivedSessionFaultEventId, LogStringFormatTable.BackendResponseReceivedSessionFault, SessionId, TaskId, MessageId, FaultCode);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendResponseReceivedSessionFault(SessionId, TaskId, MessageId, FaultCode);
        }
        
        public bool LogBackendValidateClientFailed(string SessionId, string TaskId, System.Guid MessageId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.BackendValidateClientFailedEventId, LogStringFormatTable.BackendValidateClientFailed, SessionId, TaskId, MessageId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendValidateClientFailed(SessionId, TaskId, MessageId);
        }
        
        public bool LogBackendResponseStored(string SessionId, string TaskId, System.Guid MessageId, bool Fault)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, RuntimeTraceEventIdConst.BackendResponseStoredEventId, LogStringFormatTable.BackendResponseStored, SessionId, TaskId, MessageId, Fault);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendResponseStored(SessionId, TaskId, MessageId, Fault);
        }
        
        public bool LogSessionCreating(string SessionId, string UserName)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.SessionCreatingEventId, LogStringFormatTable.SessionCreating, SessionId, UserName);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogSessionCreating(SessionId, UserName);
        }
        
        public bool LogSessionCreated(string SessionId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.SessionCreatedEventId, LogStringFormatTable.SessionCreated, SessionId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogSessionCreated(SessionId);
        }
        
        public bool LogFailedToCreateSession(string SessionId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.FailedToCreateSessionEventId, LogStringFormatTable.FailedToCreateSession, SessionId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogFailedToCreateSession(SessionId);
        }
        
        public bool LogSessionFinished(string SessionId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.SessionFinishedEventId, LogStringFormatTable.SessionFinished, SessionId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogSessionFinished(SessionId);
        }
        
        public bool LogSessionFinishedBecauseOfJobCanceled(string SessionId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.SessionFinishedBecauseOfJobCanceledEventId, LogStringFormatTable.SessionFinishedBecauseOfJobCanceled, SessionId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogSessionFinishedBecauseOfJobCanceled(SessionId);
        }
        
        public bool LogSessionFinishedBecauseOfTimeout(string SessionId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.SessionFinishedBecauseOfTimeoutEventId, LogStringFormatTable.SessionTimeoutToFinished, SessionId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogSessionFinishedBecauseOfTimeout(SessionId);
        }
        
        public bool LogSessionSuspended(string SessionId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.SessionSuspendedEventId, LogStringFormatTable.SessionSuspended, SessionId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogSessionSuspended(SessionId);
        }
        
        public bool LogSessionSuspendedBecauseOfJobCanceled(string SessionId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.SessionSuspendedBecauseOfJobCanceledEventId, LogStringFormatTable.SessionSuspendedBecauseOfJobCanceled, SessionId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogSessionSuspendedBecauseOfJobCanceled(SessionId);
        }
        
        public bool LogSessionSuspendedBecauseOfTimeout(string SessionId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.SessionSuspendedBecauseOfTimeoutEventId, LogStringFormatTable.SessionTimeoutToSuspended, SessionId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogSessionSuspendedBecauseOfTimeout(SessionId);
        }
        
        public bool LogSessionRaisedUp(string SessionId, string UserName)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.SessionRaisedUpEventId, LogStringFormatTable.SessionRaisedUp, SessionId, UserName);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogSessionRaisedUp(SessionId, UserName);
        }
        
        public bool LogSessionRaisedUpFailover(string SessionId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.SessionRaisedUpFailoverEventId, LogStringFormatTable.SessionRaisedUpFailover, SessionId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogSessionRaisedUpFailover(SessionId);
        }
        
        public bool LogBrokerWorkerUnexpectedlyExit(int Id, string Message)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Error, RuntimeTraceEventIdConst.BrokerWorkerUnexpectedlyExitEventId, LogStringFormatTable.BrokerWorkerUnexpectedlyExitString, Id, Message);
            if ((this.IsTraceEnabled("0") == false))
            {
                return false;
            }
            return this.etwTrace.LogBrokerWorkerUnexpectedlyExit(Id, Message);
        }
        
        public bool LogBrokerWorkerMessage(int Id, string Message)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.BrokerWorkerMessageEventId, LogStringFormatTable.BrokerWorkerMessageString, Id, Message);
            if ((this.IsTraceEnabled("0") == false))
            {
                return false;
            }
            return this.etwTrace.LogBrokerWorkerMessage(Id, Message);
        }
        
        public bool LogBrokerWorkerProcessReady(int PID)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.BrokerWorkerProcessReadyEventId, LogStringFormatTable.BrokerWorkerProcessCreated, PID);
            if ((this.IsTraceEnabled("0") == false))
            {
                return false;
            }
            return this.etwTrace.LogBrokerWorkerProcessReady(PID);
        }
        
        public bool LogBrokerWorkerProcessExited(int PID, int ExitCode)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.BrokerWorkerProcessExitedEventId, LogStringFormatTable.BrokerWorkerProcessExited, PID, ExitCode);
            if ((this.IsTraceEnabled("0") == false))
            {
                return false;
            }
            return this.etwTrace.LogBrokerWorkerProcessExited(PID, ExitCode);
        }
        
        public bool LogBrokerWorkerProcessFailedToInitialize(int PID)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.BrokerWorkerProcessFailedToInitializeEventId, LogStringFormatTable.BrokerWorkerProcessFailedToInitialize, PID);
            if ((this.IsTraceEnabled("0") == false))
            {
                return false;
            }
            return this.etwTrace.LogBrokerWorkerProcessFailedToInitialize(PID);
        }
        
        public bool LogBrokerClientCreated(string SessionId, string ClientId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.BrokerClientCreatedEventId, LogStringFormatTable.BrokerClientCreated, SessionId, ClientId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBrokerClientCreated(SessionId, ClientId);
        }
        
        public bool LogBrokerClientStateTransition(string SessionId, string ClientId, string State)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.BrokerClientStateTransitionEventId, LogStringFormatTable.BrokerClientStateTransition, SessionId, ClientId, State);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBrokerClientStateTransition(SessionId, ClientId, State);
        }
        
        public bool LogBrokerClientRejectFlush(string SessionId, string ClientId, string State)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.BrokerClientRejectFlushEventId, LogStringFormatTable.BrokerClientRejectFlush, SessionId, ClientId, State);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBrokerClientRejectFlush(SessionId, ClientId, State);
        }
        
        public bool LogBrokerClientRejectEOM(string SessionId, string ClientId, string State)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.BrokerClientRejectEOMEventId, LogStringFormatTable.BrokerClientRejectEOM, SessionId, ClientId, State);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBrokerClientRejectEOM(SessionId, ClientId, State);
        }
        
        public bool LogBrokerClientTimedOut(string SessionId, string ClientId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.BrokerClientTimedOutEventId, LogStringFormatTable.BrokerClientTimedOut, SessionId, ClientId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBrokerClientTimedOut(SessionId, ClientId);
        }
        
        public bool LogBrokerClientAllResponseDispatched(string SessionId, string ClientId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.BrokerClientAllResponseDispatchedEventId, LogStringFormatTable.BrokerClientAllResponseDispatched, SessionId, ClientId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBrokerClientAllResponseDispatched(SessionId, ClientId);
        }
        
        public bool LogBrokerClientAllRequestDone(string SessionId, string ClientId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.BrokerClientAllRequestDoneEventId, LogStringFormatTable.BrokerClientAllRequestDone, SessionId, ClientId);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBrokerClientAllRequestDone(SessionId, ClientId);
        }
        
        public bool LogBrokerClientDisconnected(string SessionId, string ClientId, string State)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.BrokerClientDisconnectedEventId, LogStringFormatTable.BrokerClientDisconnected, SessionId, ClientId, State);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBrokerClientDisconnected(SessionId, ClientId, State);
        }
        
        public bool LogUserTraceVerbose(string SessionId, System.Guid MessageId, System.Guid DispatchId, string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, RuntimeTraceEventIdConst.UserTraceVerboseEventId, LogStringFormatTable.UserTraceMessage, SessionId, MessageId, DispatchId, String);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogUserTraceVerbose(SessionId, MessageId, DispatchId, String);
        }
        
        public bool LogUserTraceInfo(string SessionId, System.Guid MessageId, System.Guid DispatchId, string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.UserTraceInfoEventId, LogStringFormatTable.UserTraceMessage, SessionId, MessageId, DispatchId, String);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogUserTraceInfo(SessionId, MessageId, DispatchId, String);
        }
        
        public bool LogUserTraceWarning(string SessionId, System.Guid MessageId, System.Guid DispatchId, string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, RuntimeTraceEventIdConst.UserTraceWarningEventId, LogStringFormatTable.UserTraceMessage, SessionId, MessageId, DispatchId, String);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogUserTraceWarning(SessionId, MessageId, DispatchId, String);
        }
        
        public bool LogUserTraceError(string SessionId, System.Guid MessageId, System.Guid DispatchId, string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Error, RuntimeTraceEventIdConst.UserTraceErrorEventId, LogStringFormatTable.UserTraceMessage, SessionId, MessageId, DispatchId, String);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogUserTraceError(SessionId, MessageId, DispatchId, String);
        }
        
        public bool LogUserTraceCritial(string SessionId, System.Guid MessageId, System.Guid DispatchId, string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Critical, RuntimeTraceEventIdConst.UserTraceCritialEventId, LogStringFormatTable.UserTraceMessage, SessionId, MessageId, DispatchId, String);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogUserTraceCritial(SessionId, MessageId, DispatchId, String);
        }
        ...
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.FrontendBindingLoadedEventId, LogStringFormatTable.FrontendBindingLoaded, SessionId, Symbol, MaxMessageSize, ReceiveTimeout, SendTimeout, MessageVersion, Scheme);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogFrontendBindingLoaded(SessionId, Symbol, MaxMessageSize, ReceiveTimeout, SendTimeout, MessageVersion, Scheme);
        }
        ...
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.BackendBindingLoadedEventId, LogStringFormatTable.BackendBindingLoaded, SessionId, Symbol, MaxMessageSize, ReceiveTimeout, SendTimeout, MessageVersion, Scheme);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogBackendBindingLoaded(SessionId, Symbol, MaxMessageSize, ReceiveTimeout, SendTimeout, MessageVersion, Scheme);
        }
        
        public bool LogFrontendCreated(string SessionId, string Symbol, string FrontendUri)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.FrontendCreatedEventId, LogStringFormatTable.FrontendCreated, SessionId, Symbol, FrontendUri);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogFrontendCreated(SessionId, Symbol, FrontendUri);
        }
        
        public bool LogFrontendControllerCreated(string SessionId, string Symbol, string ControllerUri, string GetResponseUri)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.FrontendControllerCreatedEventId, LogStringFormatTable.FrontendControllerCreated, SessionId, Symbol, ControllerUri, GetResponseUri);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogFrontendControllerCreated(SessionId, Symbol, ControllerUri, GetResponseUri);
        }
        
        public bool LogQueueCreatedOrExist(string SessionId, string QueueName)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.QueueCreatedOrExistEventId, LogStringFormatTable.QueueCreatedOrExist, SessionId, QueueName);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogQueueCreatedOrExist(SessionId, QueueName);
        }
        
        public bool LogQueueDeleted(string SessionId, string QueueName)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, RuntimeTraceEventIdConst.QueueDeletedEventId, LogStringFormatTable.QueueDeleted, SessionId, QueueName);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogQueueDeleted(SessionId, QueueName);
        }
        
        public bool LogQueueNotExist(string SessionId, string QueueName)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Error, RuntimeTraceEventIdConst.QueueNotExistEventId, LogStringFormatTable.QueueNotExist, SessionId, QueueName);
            if ((this.IsTraceEnabled(SessionId) == false))
            {
                return false;
            }
            return this.etwTrace.LogQueueNotExist(SessionId, QueueName);
        }
    }
    ...
    public sealed class SOADiagTraceWrapper
    {
        ...
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, SOADiagTraceEventIdConst.TextVerboseEventId, LogStringFormatTable.PureString, String);
            return this.etwTrace.LogTextVerbose(String);
        }
        
        public bool LogTextInfo(string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, SOADiagTraceEventIdConst.TextInfoEventId, LogStringFormatTable.PureString, String);
            return this.etwTrace.LogTextInfo(String);
        }
        
        public bool LogTextWarning(string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, SOADiagTraceEventIdConst.TextWarningEventId, LogStringFormatTable.PureString, String);
            return this.etwTrace.LogTextWarning(String);
        }
        
        public bool LogTextError(string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Error, SOADiagTraceEventIdConst.TextErrorEventId, LogStringFormatTable.PureString, String);
            return this.etwTrace.LogTextError(String);
        }
        
        public bool LogTextCritial(string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Critical, SOADiagTraceEventIdConst.TextCritialEventId, LogStringFormatTable.PureString, String);
            return this.etwTrace.LogTextCritial(String);
        }
        
        public bool LogEventReceived(int EventId)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, SOADiagTraceEventIdConst.EventReceivedEventId, LogStringFormatTable.EventReceived, EventId);
            return this.etwTrace.LogEventReceived(EventId);
        }
        
        public bool LogEventBuffered(int EventId, string SessionId, int BufferId, int Count, System.DateTime CreatedTime)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, SOADiagTraceEventIdConst.EventBufferedEventId, LogStringFormatTable.EventBuffered, EventId, SessionId, BufferId, Count, CreatedTime);
            return this.etwTrace.LogEventBuffered(EventId, SessionId, BufferId, Count, CreatedTime);
        }
        
        public bool LogBufferWritten(int BufferId, int Count, System.DateTime CreatedTime)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, SOADiagTraceEventIdConst.BufferWrittenEventId, LogStringFormatTable.BufferWritten, BufferId, Count, CreatedTime);
            return this.etwTrace.LogBufferWritten(BufferId, Count, CreatedTime);
        }
        
        public bool LogBufferDiscarded(int BufferId, int Count, System.DateTime CreatedTime, string Exception)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, SOADiagTraceEventIdConst.BufferDiscardedEventId, LogStringFormatTable.BufferDiscarded, BufferId, Count, CreatedTime, Exception);
            return this.etwTrace.LogBufferDiscarded(BufferId, Count, CreatedTime, Exception);
        }
        
        public bool LogStartThrottle(int CurrentBufferSize)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, SOADiagTraceEventIdConst.StartThrottleEventId, LogStringFormatTable.StartThrottle, CurrentBufferSize);
            return this.etwTrace.LogStartThrottle(CurrentBufferSize);
        }
        
        public bool LogStopThrottle(int CurrentBufferSize)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, SOADiagTraceEventIdConst.StopThrottleEventId, LogStringFormatTable.StopThrottle, CurrentBufferSize);
            return this.etwTrace.LogStopThrottle(CurrentBufferSize);
        }
    }
    ...
    public sealed class DataSvcTraceWrapper
    {
        ...
        public bool LogTextVerbose(string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Verbose, DataSvcTraceEventIdConst.TextVerboseEventId, LogStringFormatTable.PureString, String);
            return this.etwTrace.LogTextVerbose(String);
        }
        
        public bool LogTextInfo(string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Information, DataSvcTraceEventIdConst.TextInfoEventId, LogStringFormatTable.PureString, String);
            return this.etwTrace.LogTextInfo(String);
        }
        
        public bool LogTextWarning(string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Warning, DataSvcTraceEventIdConst.TextWarningEventId, LogStringFormatTable.PureString, String);
            return this.etwTrace.LogTextWarning(String);
        }
        
        public bool LogTextError(string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Error, DataSvcTraceEventIdConst.TextErrorEventId, LogStringFormatTable.PureString, String);
            return this.etwTrace.LogTextError(String);
        }
        
        public bool LogTextCritial(string String)
        {
            this.cosmosTrace.TraceEvent(System.Diagnostics.TraceEventType.Critical, DataSvcTraceEventIdConst.TextCritialEventId, LogStringFormatTable.PureString, String);
            return this.etwTrace.LogTextCritial(String);
        }
    }
